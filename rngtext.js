...
window.Game.yousexchat = function () {
  let arr = [
    "ahh ngh ahh...",
    "oh ahhh ngh... ",
    "(groan) (pant)... ",
...
window.Game.youcumchat = function () {
  let arr = [
    "..I'm cumming!..",
    "..I'm gonna cum!...",
    "argh!...I cant last... ",
    "..I can't take it arghh... ",
    "..it's too much...I'm.."
  ];
  return arr[Math.floor(Math.random() * arr.length)];
};
...
window.Game.sisgreet = function () {
  let sis = State.variables.NPC.sis;
  let type = sis.route + Math.min(sis.lvl, 3);
...
window.Game.nicknames = function () {
  let arr = [
    "darling",
    "sweetheart",
    "sweetie",
...
window.Game.momgreet = function () {

  let mom = State.variables.NPC.mom;
  let type;
  if (State.variables.NPC.mom.route == "") type = "l1";
  else type = mom.route + Math.min(mom.lvl, 3);
  let nick = window.Game.nicknames();
